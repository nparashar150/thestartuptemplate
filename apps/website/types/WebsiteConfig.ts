...
type Hero = Section<{ pretitle: string; title: string; subtitle: string; curlyText: string; primaryButtonText: string; primaryButtonShowIcon: boolean; secondaryButtonText: string; cards: { [key: string]: any } }>;
