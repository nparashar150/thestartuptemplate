    ...
    <section className="relative container grid lg:grid-cols-2 place-items-center py-20 md:py-32 gap-10">
      ...
      <div className="text-center lg:text-start space-y-6">
        <AnimatedGradientText className="mx-auto lg:mx-0">
          ...
          <span className={cn(`inline animate-gradient bg-gradient-to-r from-[#F596D3] via-[#1fc0f1] to-[#D247BF] bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent`)}>Introducing The Startup Template</span>
        ...
        <p className="text-xl text-muted-foreground md:w-10/12 mx-auto lg:mx-0">Everything you need to build, launch, and grow your web app effortlessly. Focus on your vision, and start making your first $ faster.</p>
